...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../MappingRobot.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10120a8
SOPC_SYSID_FLAG += --sidp=0x10120a8
ELF_PATCH_FLAG  += --sidp 0x10120a8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1458335708
SOPC_SYSID_FLAG += --timestamp=1458335708
ELF_PATCH_FLAG  += --timestamp 1458335708
